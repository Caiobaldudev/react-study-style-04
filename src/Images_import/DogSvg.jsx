...
// posso transformar o svg em um componente e definir variáveis para ele, até animá-lo!
// Exemplo: color => no App onde tenho a tag DogSvg eu posso simplesmente passar uma outra cor.
const DogSvg = ({ color }) => {
  return (
    <svg
      width="28"
